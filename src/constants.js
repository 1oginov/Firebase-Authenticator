...
export const REDIRECT_QUERY_PARAMETER = process.env.REDIRECT_QUERY_PARAMETER;

export const REDIRECT_REFRESH_TOKEN_PLACEHOLDER = process.env.REDIRECT_REFRESH_TOKEN_PLACEHOLDER;
